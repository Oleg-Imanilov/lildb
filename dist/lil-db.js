(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('crypto'), require('fs')) :
	typeof define === 'function' && define.amd ? define(['crypto', 'fs'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.LilDb = factory(global.require$$0, global.fs));
	...
	function deepValue$1(key, doc) {
	    ...
	    if (kk.length === 1) {
	        ...
	        return deepValue$1(kk.slice(1), d)
	    }
	}
	...
	function project(doc, projection) {
	    ...
	    Object.keys(projection).forEach(k => {
	        projected[k] = deepValue$1(projection[k], doc);
	    });
	    return projected
	}
	...
	var utils = {
	    uuid,
	    deepValue: deepValue$1,
	    deepValueSet,
	    deepUpdate,
	    project
	};

	const { deepValue } = utils;
	...
	var LilDbExports = LilDb$1.exports;
	var LilDb = /*@__PURE__*/getDefaultExportFromCjs(LilDbExports);
